...
function Scene3D() {
  ...
  return (
    <Canvas
      shadows
      camera={{
        position: isSmallMobile ? [0, 1.35, 9.8] : (isMobile ? [0, 1.4, 8.2] : [0, 1.45, 6.2]),
        fov: isSmallMobile ? 46 : (isMobile ? 42 : 38)
      }}
    ...
    >
      ...
      <Suspense fallback={null}>
        ...
        <SpeechBubble
          ...
          text={bubbleText}
          scale={isSmallMobile ? 0.135 : (isMobile ? 0.16 : 0.18)}
          yPos={isSmallMobile ? 2.15 : 2.35}
        />
        ...
        <LoginForm
          ...
          htmlScale={isSmallMobile ? 0.135 : (isMobile ? 0.155 : 0.175)}
